...
from v.project.model.projectTaskIssueMdl import ProjectIssueMdl


class ProjectIssueListRst(Resource, ProjectIssueMdl):
    def get(self):
        try:
...
class ProjectIssueRst(Resource, ProjectIssueMdl):
    def get(self, id):
        try:
