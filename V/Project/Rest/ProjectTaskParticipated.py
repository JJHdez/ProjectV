...
class ProjectParticipatedListRst(Resource, ProjectParticipatedRsc):
    def get(self):
        try:
...
class ProjectParticipatedRst(Resource, ProjectParticipatedRsc):
    def get(self, id):
        try:
